...
<template>
    ...
    <div>
        <div class="flex flex-col lg:flex-row gap-5 mt-5 px-5">
            <div class="flex items-center gap-7 p-5 shadow-md">
            ...
            <div class="flex items-center gap-7 p-5 shadow-md">
                <i class="fa fa-pie-chart fa-2xl text-green-800"></i>
                <div>
            ...
            <div class="flex items-center gap-7 p-5 shadow-md">
                <i class="fas fa-money-bill fa-2xl text-green-800"></i>
                <div>
    ...
    <div class="max-w-lg mx-10 my-20">
        <h2 class="text-4xl font-extrabold py-5">Investing has never been easier</h2>
        <p>With years of experience in providing funds management services and a team of seasoned experts working
